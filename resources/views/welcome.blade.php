    ...
    <div class="container">
        <div class="d-sm-flex">
            <div>
                ...
                <p class="lead">
                    Utopian gives you the best price in the market. It hosts regular campaigns and flash sales which give the
                    chance to the customers to avail the product at the most affordable price in the country.
                </p>
                @guest
                @if (Route::has('login'))
